                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="avatar" type="file" class="dropify form-control @error('avatar') is-invalid @enderror" name="avatar" data-default-file="{{ Auth::user()->getFirstMediaUrl('avatar') }}">
                                    @error('avatar')
                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email"  type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ Auth::user()->email }}" required autofocus>
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
